...
public class Sonic {
    ...
    public boolean getChordPitch() { return useChordPitch; }
    public void setChordPitch(boolean useChordPitch) { this.useChordPitch = useChordPitch; }
    ...
    public void setSampleRate(int sampleRate) { allocateStreamBuffers(sampleRate, numChannels); }
    public int getNumChannels() { return numChannels; }
    public void setNumChannels(int numChannels) { allocateStreamBuffers(sampleRate, numChannels); }
    ...
    private short interpolate(short in[], int inPos, int oldSampleRate, int newSampleRate) {
        int i, total = 0, weight, value, oldSign, overflowCount = 0;
